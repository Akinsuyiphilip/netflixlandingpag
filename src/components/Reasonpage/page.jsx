    ...
    <>
      <section className=" z-20 flex flex-col bg-black w-full">
        <div className="mx-4 md:mx-14 lg:mx-32 my-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5 w-full mt-4">
            {/* Card 1 */}
            <div
              className="relative w-full px-6 pt-6 pb-24 rounded-2xl border border-white/10"
              style={{
                background:
                  "radial-gradient(600px 320px at 90% 85%, rgba(199,75,223,0.35) 0%, rgba(199,75,223,0.10) 45%, rgba(199,75,223,0) 70%), linear-gradient(180deg, #1b2140 0%, #161a31 50%, #1a1220 100%)",
              }}
            >
            ...
            >
              ...
              <p className="text-gray-300 text-sm leading-relaxed">
                Stream on phone, tablet, laptop, and TV without limits.
              </p>
              <div className="absolute right-1 bottom-3">
                <svg width="72" height="72" viewBox="0 0 72 72" fill="none">
            ...
            >
              ...
              <p className="text-gray-300 text-sm leading-relaxed">
                Send kids on adventures in a space made just for them.
              </p>
              <div className="absolute right-1 bottom-3">
                <svg width="72" height="72" viewBox="0 0 72 72" fill="none">
